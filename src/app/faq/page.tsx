    ...
    questions: [
      {
        ...
        a: "Mentoria Hub — образовательная платформа для учеников 8-12 классов. Мы помогаем находить стипендии, конкурсы, олимпиады, летние программы и предлагаем асинхронные курсы для подготовки."
      },
      {
        q: "Для кого эта платформа?",
        a: "Платформа создана для школьников 8-12 классов из Казахстана и других стран, которые хотят развиваться, участвовать в конкурсах и готовиться к поступлению в топ-вузы."
      },
      {
